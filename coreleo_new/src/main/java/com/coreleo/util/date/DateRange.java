...
public class DateRange implements Comparable, Serializable {
	...
	/**
	 * Creates a new DateRange from the string provided, assuming the string has
	 * the dates in the appropriate format (stardate - enddate). Dates are in
	 * the format of 'MM-dd-yyyy'.
	 * 
	 * @param dateRange
	 *            String format date range (same as toString() return value for
	 *            this class).
	 */
	...
	public int compareTo(Object obj) {
		...
		DateRange another = (DateRange) obj;
		int compare = start.compareTo(another.getStartDate());
