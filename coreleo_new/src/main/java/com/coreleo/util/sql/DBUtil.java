...
import com.coreleo.util.sql.parser.*;
import javax.sql.*;
 ...
 * @author Leon Samaroo
 * 
 * <br/> Convenience functions for dealing with jdbc.
 * 
 */
public final class DBUtil {
	public final static int TYPES_ORACLECURSOR = -10; 
	private final static int[] TYPES = new int[] { Types.INTEGER, Types.VARCHAR, Types.TIMESTAMP, Types.DOUBLE, Types.BIGINT, Types.DATE, Types.FLOAT, Types.LONGVARCHAR, Types.TINYINT, Types.NUMERIC, Types.TIME, Types.CHAR, Types.OTHER };
	...
	public final static Driver registerDriver( String driverClassName ){
		...
		try {
			Driver driver = (Driver) ReflectionUtil.newInstance(driverClassName);
...
//	}
	...
	private static final int update(int queryTimeOut, Object connectionSource, String sql, Object... params) throws SimpleSqlException {
		String log = getLogString("update", -1, -1, queryTimeOut, sql, params ); 
		LogUtil.trace( log );
	...
	public static final List<?> queryForListOfArrays(Object connectionSource, String sql) throws SimpleSqlException {
		return (List<?>) query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new ListParser(new RowAsArray()), (Object[]) null);
	}
...
//	}
	...
	public static final List<?> queryForList(Object connectionSource, String sql, RowParser rowParser) throws SimpleSqlException {
		return (List<?>) query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new ListParser(rowParser), (Object[]) null);
	}
...
//	}
	...
	public static final Map<?, ?> queryForMap(Object connectionSource, String sql, RowParser rowParser, String nameOfColumnToUseAsKey) throws SimpleSqlException {
		return (Map<?, ?>) query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new LinkedHashMapParser(rowParser, nameOfColumnToUseAsKey), (Object[]) null);
	}
	...
	public static final Map<?, ?> queryForMap(Object connectionSource, String sql, RowParser rowParser, int indexOfColumnToUseAsKey) throws SimpleSqlException {
		return (Map<?, ?>) query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new LinkedHashMapParser(rowParser, indexOfColumnToUseAsKey), (Object[]) null);
	}
	...
	public static final Map<?, ?> queryForMap(Object connectionSource, String sql, RowParser rowParser, RowParser keyParser) throws SimpleSqlException {
		return (Map<?, ?>) query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new LinkedHashMapParser(rowParser, keyParser), (Object[]) null);
	}
...
//	}
	...
	public static final Map<?, ?> queryForMap(Object connectionSource, String sql, RowParser rowParser, String nameOfColumnToUseAsKey, Object... params) throws SimpleSqlException {
		return (Map<?, ?>) query(connectionSource, sql, new LinkedHashMapParser(rowParser, nameOfColumnToUseAsKey), params);
	}


	public static final Map<?, ?> queryForMap(Object connectionSource, String sql, RowParser rowParser, int indexOfColumnToUseAsKey, Object... params) throws SimpleSqlException {
	...
	public static final Object queryForFirstRow(Object connectionSource, String sql, RowParser rowParser) throws SimpleSqlException {
		return query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new FirstRowOnlyParser(rowParser), (Object[]) null);
	}
...
//	}
	...
	public static final Object queryForColumn(Object connectionSource, String sql, String columnName, Object... params) throws SimpleSqlException {
		return query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new ColumnFromFirstRowParser(columnName), params);
	}
...
//	}
	...
	public static final Object queryForColumn(Object connectionSource, String sql, int columnIndex, Object... params) throws SimpleSqlException {
		return query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new ColumnFromFirstRowParser(columnIndex), params);
	}


	public static final Object queryForColumn(Object connectionSource, String sql, int columnIndex) throws SimpleSqlException {
		return query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new ColumnFromFirstRowParser(columnIndex), (Object[]) null);
	}


	public static final Object queryForColumn(Object connectionSource, String sql, String columnName) throws SimpleSqlException {
		return query(ResultSet.TYPE_FORWARD_ONLY, ResultSet.CONCUR_READ_ONLY, QUERY_TIMEOUT, connectionSource, sql, new ColumnFromFirstRowParser(columnName), (Object[]) null);
	}
...
//	}
	...
	public static final Object query(Object connectionSource, String sql, ResultSetParser handler, int resultSetType, int resultSetConcurrency) throws SimpleSqlException {
		return query(resultSetType, resultSetConcurrency, QUERY_TIMEOUT, connectionSource, sql, handler, (Object[]) null);
	}
	

	
	private static final Object query(int resultSetType, int resultSetConcurrency, int queryTimeOut, Object connectionSource, String sql, ResultSetParser handler, Object... params) throws SimpleSqlException {
		String log = getLogString("query", resultSetType, resultSetConcurrency, queryTimeOut, sql, params );
		LogUtil.trace( log );
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		Connection con = null;
...
//	}
	...
	private static final List<OutParameter> call(int resultSetType, int resultSetConcurrency, int queryTimeOut, Object connectionSource, String sql, Object... params) throws SimpleSqlException {
		String log = getLogString("call", resultSetType, resultSetConcurrency, queryTimeOut, sql, params );
		LogUtil.trace( log );
		
		CallableStatement cstmt = null;
		ResultSet rs = null;
		Connection con = null;
		List<OutParameter> outParams = new ArrayList<OutParameter>();
		long startTime = 0;
		...
		try {		
			...
			if( CollectionUtil.isNotEmpty(outParams) ){
				for( int i = 0; i < outParams.size(); i++ ){
					OutParameter out = (OutParameter) outParams.get(i);
					out.setValue(cstmt);
				}
			}
