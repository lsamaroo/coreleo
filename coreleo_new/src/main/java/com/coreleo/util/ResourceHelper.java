...
public final class ResourceHelper {
	 ...
	 * @return the Properties object associated with the filename, null if
	 ...
	 * 
	 * <p>
	 * This method attempts to locate a resource when the path to that resource
	 * is a relative path. The task of locating the resource specified by param
	 * fileName is delegated to <code>Class.getResource</code>.
	 * </p>
	 * <p>
	 * This is an alternative to using <code>ServletContent.getResource</code>.
	 * For example, when a <code>ServletContext</code> is not readily
	 * available such as in a POJO (Plain Ordinary Java Objec).
	 * </p>
	 * 
	 ...
	 * @return the File object represent the resource, null if unable to locate
	 *         the resource.
	 */
