...
public class BooleanUtil {
	...
	/**
	 * 
	 * If the arg is yes or y (case doesn't matter) then it returns
	 * Boolean.TRUE, otherwise Boolean.False
	 * 
	 */
	public static final Boolean toBooleanObjectIgnoreCaseYesNoYN(String yesOrNoString) {
		if (yesOrNoString == null) {
			return Boolean.FALSE;
		}

		String trimmedCaseInsensitiveString = yesOrNoString.trim().toLowerCase();
	...
	public static final boolean toBooleanIgnoreCaseYesNoYN(Object yesOrNoString) {
		if (yesOrNoString == null) {
			return false;
		}

		String trimmedCaseInsensitiveString = yesOrNoString.toString().trim().toLowerCase();
		if (trimmedCaseInsensitiveString.equals("yes") || trimmedCaseInsensitiveString.equals("y")) {
			return true;
		}
