 ...
 *         combination. Getting a value from this Grid will return a List,
 *         holding all the values put to that row-column.
 * 
 */
public class MultiGrid extends SimpleGrid {
	...
	/**
	 * @return a java.util.List containing the values located at the specified row and column index, or null if the Grid contains no value at this row-column index combination.
	 * 
	 */
	...
	/**
	 * @return a java.util.List containing the values located at the specified row and column, or null if the Grid contains no value at this row-column combination.
	 * 
	 */
