...
/**
 * 
 * @author Leon Samaroo Uses reflection to avoid compile dependencies on the spring library. However if this utility is used, the
 *         spring jar is required.
 */
public class SpringUtil
{
	...
	{
		final Object wac = ReflectionUtil.invokeStatic(WEB_APPLICATION_CONTEXT_UTILS, GET_REQUIRED_WEB_APPLICATION_CONTEXT, sc);
