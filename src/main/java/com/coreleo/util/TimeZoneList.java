...
public class TimeZoneList {
	...
	static
	{
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Argentina Standard Time", "America/Buenos_Aires",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Canada Central Standard Time", "America/Regina",
				"(UTC -06:00) Saskatchewan"));
		ZONEMAPPINGS.add(new TimeZoneMapping("Cape Verde Standard Time", "Atlantic/Cape_Verde",
				"(UTC -01:00) Cape Verde Is."));
		ZONEMAPPINGS.add(new TimeZoneMapping("Caucasus Standard Time", "Asia/Yerevan", "(UTC +04:00) Yerevan"));
		ZONEMAPPINGS.add(new TimeZoneMapping("Cen. Australia Standard Time", "Australia/Adelaide",
				"(UTC +09:30) Adelaide"));
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("E. Australia Standard Time", "Australia/Brisbane",
				"(UTC +10:00) Brisbane"));
		ZONEMAPPINGS.add(new TimeZoneMapping("E. Europe Standard Time", "Europe/Minsk", "(UTC +02:00) Minsk"));
		ZONEMAPPINGS.add(new TimeZoneMapping("E. South America Standard Time", "America/Sao_Paulo",
				"(UTC -03:00) Brasilia"));
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Ekaterinburg Standard Time", "Asia/Yekaterinburg",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("UTC Standard Time", "Europe/London",
				"(UTC) Dublin, Edinburgh, Lisbon, London"));
		ZONEMAPPINGS.add(new TimeZoneMapping("Greenland Standard Time", "America/Godthab", "(UTC -03:00) Greenland"));
		ZONEMAPPINGS.add(new TimeZoneMapping("Greenwich Standard Time", "Atlantic/Reykjavik",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Montevideo Standard Time", "America/Montevideo",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("N. Central Asia Standard Time", "Asia/Novosibirsk",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Newfoundland Standard Time", "America/St_Johns",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Pakistan Standard Time", "Asia/Karachi",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("SA Eastern Standard Time", "America/Cayenne",
				"(UTC -03:00) Cayenne, Fortaleza"));
		ZONEMAPPINGS.add(new TimeZoneMapping("SA Pacific Standard Time", "America/Bogota",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("SE Asia Standard Time", "Asia/Bangkok",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Sri Lanka Standard Time", "Asia/Colombo",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Ulaanbaatar Standard Time", "Asia/Ulaanbaatar",
				"(UTC +08:00) Ulaanbaatar"));
		ZONEMAPPINGS.add(new TimeZoneMapping("US Eastern Standard Time", "America/Indianapolis",
		...
		ZONEMAPPINGS.add(new TimeZoneMapping("Vladivostok Standard Time", "Asia/Vladivostok",
	...
	private TimeZoneList() {
		...
		for (final TimeZoneMapping zoneMapping : ZONEMAPPINGS)
		{
			...
			if (availableIdsSet.contains(id))
			{
				...
				timeZones.add(new TimeZoneWithDisplayNames(timeZone, zoneMapping.getWindowsDisplayName(), zoneMapping
